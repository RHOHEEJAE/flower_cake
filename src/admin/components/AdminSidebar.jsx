...
const NAV_ITEMS = [
  ...
  { to: '/admin/products', label: '상품 목록', icon: (
    <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4" />
    </svg>
  )},
  { to: '/admin/products/new', label: '상품 등록', icon: (
    <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M12 4v16m8-8H4" />
    </svg>
  )},
  { to: '/admin/orders', label: '주문 목록', icon: (
    <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2" />
    </svg>
  )},
  { to: '/admin/inventory', label: '재고 관리', icon: (
    <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  return (
    <aside className="w-56 min-h-screen bg-brand-dark flex flex-col shrink-0">
      <div className="p-6 border-b border-brand-cream/10">
        <h1 className="font-serif text-lg text-brand-cream tracking-widest">花菓子</h1>
        <p className="font-sans text-xs text-brand-cream/40 mt-1">관리자 대시보드</p>
      </div>
